...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiControl = __webpack_require__(187);

	var _apiControl2 = _interopRequireDefault(_apiControl);
	...
	var Page = function (_React$Component) {
	    ...
	    _createClass(Page, [{
	        key: 'onMapAvailable',
	        value: function onMapAvailable(map) {
	            map.controls.add((0, _apiControl2.default)(this._ymaps), { float: 'left' });
	        }
	    }, {
	        key: 'onAPIAvailable',
	        value: function onAPIAvailable(ymaps) {
	            this._ymaps = ymaps;
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _data2.default.filter(function (point, i) {
	                    return !_this2.state.clicked || i > 2;
	                }).map(function (_ref, i) {
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        { key: 'marker_' + i, lat: lat, lon: lon, onClick: function onClick() {
	                                return alert('worked!');
	                            } },
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { style: markerStyles },
	                                _react2.default.createElement('img', { src: 'http://dummyimage.com/40x40/ccc/000' })
	                            )
	                        )
	                    );
	                })
	...
	_reactDom2.default.render(_react2.default.createElement(Page, null), document.getElementById('container'));
...
/***/ function(module, exports) {
	...
	function create(ymaps) {
	    var ButtonLayout = ymaps.templateLayoutFactory.createClass("<button class='my-button {% if state.selected %}my-button-selected{% endif %}'>" + "{{data.content}}" + "</button>");
